...
urlpatterns = [
    ...
    path('notes/import/', views.ImportStandaloneNotesView.as_view(), name='notes-import'),
    ...
    path('note-sync/refresh/', views.NoteSyncRefreshAllView.as_view(), name='note-sync-refresh-all'),
    path('note-sync/documents/<int:pk>/', views.DocumentNoteSyncView.as_view(), name='document-note-sync'),
    path('note-sync/documents/<int:pk>/resolve/', views.DocumentNoteSyncResolveView.as_view(), name='document-note-sync-resolve'),
